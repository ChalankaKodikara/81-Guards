  ...
  const handleFetchData = async () => {
    if (startDate && endDate) {
      ...
      if (userType === "superadmin") {
        endpoint = `https://back-demo-local-hris.quortech-technologies.com/v1/hris/attendence/getAttendanceHistroy?startDate=${formattedStartDate}&endDate=${formattedEndDate}`;
      } else if (userType === "admin" && supervisorId) {
        endpoint = `https://back-demo-local-hris.quortech-technologies.com/v1/hris/attendence/getAttendanceHistroybysupervisor?startDate=${formattedStartDate}&endDate=${formattedEndDate}&supervisorId=${supervisorId}`;
      } else {
